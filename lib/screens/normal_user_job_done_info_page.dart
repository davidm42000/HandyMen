...
class NormalUserJobsDoneInfoPage extends StatefulWidget {
  final User user;
  final String docID;
  const NormalUserJobsDoneInfoPage({
    Key? key,
    required this.user,
    required this.docID,
  }) : super(key: key);
  ...
  @override
  _NormalUserJobsDoneInfoPageState createState() =>
      _NormalUserJobsDoneInfoPageState();
}

class _NormalUserJobsDoneInfoPageState
    extends State<NormalUserJobsDoneInfoPage> {

...
class FavouriteTradesmenList extends StatefulWidget {
  final User user;
  final double distance;
  final String tradeType;
  const FavouriteTradesmenList(
  ...
  @override
  _FavouriteTradesmenListState createState() => _FavouriteTradesmenListState();
}

class _FavouriteTradesmenListState extends State<FavouriteTradesmenList> {
  var _example = "2km";
  ...
  // getFavsList(BuildContext context) async {
  //   FirebaseFirestore.instance
  //       .collection('normalUsers')
  //       .doc(widget.user.uid)
  //       .get()
  //       .then((value) {
  //     print("Got Favourites list.");
  //     var data = value.data();
  //     _fav_list = data!['favourites'];
  //     print(_fav_list);

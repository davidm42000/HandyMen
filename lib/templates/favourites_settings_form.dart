...
class FavouritesSettingsForm extends StatefulWidget {
  final String selectedDistance;
  final String selectedTrade;
  final User user;

  const FavouritesSettingsForm(
      {Key? key,
      required this.user,
  ...
  @override
  _FavouritesSettingsFormState createState() => _FavouritesSettingsFormState();
}

class _FavouritesSettingsFormState extends State<FavouritesSettingsForm> {
